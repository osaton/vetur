...
import { getStageDocumentRegions, StageDocumentRegions, LanguageId, LanguageRange } from './stageEmbeddedSupport'; 
...
export class LanguageModes {
  ...
  private documentRegions: LanguageModelCache<StageDocumentRegions>;
  private modelCaches: LanguageModelCache<any>[];
  private serviceHost: IServiceHost;

  constructor() {
    this.documentRegions = getLanguageModelCache<StageDocumentRegions>(10, 60, document =>
